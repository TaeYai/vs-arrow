...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'charting':
				dialogue = CoolUtil.coolTextFile(Paths.txt('charting/Song1Dialogue'));
			case 'hit-rate':
			...
			case 'white':
				{
						defaultCamZoom = 0.9;
						curStage = 'white';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('arrow/pure-white-background-85a2a7fd'));
						bg.antialiasing = true;
